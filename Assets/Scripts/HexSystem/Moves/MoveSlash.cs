...
{
    class MoveSlash<TPosition> : MoveBase<TPosition>
        where TPosition : IPosition
    {
        public MoveSlash(Board<Character<TPosition>, TPosition> board, Grid<TPosition> grid, ReplayManager replayManager) : base(board, grid, replayManager)
        {
